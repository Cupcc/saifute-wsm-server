---
name: saifute-coder
description: Implementation specialist for the Saifute WMS repository. Use when the main agent wants delegated implementation inside explicit writable boundaries. Prefer a task doc for durable or resumable work, but a precise parent handoff may also define the execution scope.
---
