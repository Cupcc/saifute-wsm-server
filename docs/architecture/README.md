...
| `20-wms-business-flow-and-optimized-schema.md` | Frozen business-flow definitions, optimized schema decisions, and domain-state semantics across inbound, customer, workshop, and inventory flows. Read this before implementing or migrating any document-flow, inventory, or workflow surface. |
...
2. `docs/architecture/20-wms-business-flow-and-optimized-schema.md` — frozen domain-flow definitions, optimized schema decisions, and domain-state semantics across inbound, customer, workshop, and inventory flows
