...
| REQ     | 功能项 | 需求摘要         | 来源  | 阶段      | 状态     | 关联任务                 |
| ------- | --- | ------------ | --- | ------- | ------ | -------------------- |
| REQ-006 | F1  | 物料分类 CRUD    | PRD | Phase 1 | ✅ 已完成  | `task-20260417-1702` |
...
| REQ-031 | F4  | 异常 / 跨月修正展示规则 | PRD | Phase 1 | ✅ 已完成  | `task-20260411-0301` |
...
| REQ     | 功能项 | 需求摘要                | 来源  | 阶段      | 状态     | 关联任务                 |
| ------- | --- | ------------------- | --- | ------- | ------ | -------------------- |
| REQ-047 | F1  | 销售项目主档轻量 CRUD       | PRD | Phase 1 | ✅ 已完成  | `task-20260410-1700` |
| REQ-048 | F2  | 项目维度库存 / 可供货视图      | PRD | Phase 1 | ✅ 已完成  | `task-20260410-1700` |
| REQ-049 | F3  | 项目关联销售出库与一键生成草稿     | PRD | Phase 2 | ✅ 已完成  | `task-20260410-1700` |
| REQ-050 | F4  | 项目维度发货 / 退货 / 净发货统计 | PRD | Phase 2 | ✅ 已完成  | `task-20260410-1700` |
