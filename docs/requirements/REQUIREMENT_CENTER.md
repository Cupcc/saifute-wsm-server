...
### 项目 / 研发 — `domain/project-management.md`

| REQ     | 功能项 | 需求摘要              | 来源  | 阶段      | 状态     | 关联任务 |
| ------- | --- | ----------------- | --- | ------- | ------ | ---- |
| REQ-047 | F1  | 项目主档轻量 CRUD 与 RD 小仓归属 | PRD | Phase 1 | 🔧 进行中 | -    |
| REQ-048 | F2  | 项目 BOM、缺料预警与采购辅助 | PRD | Phase 1 | 📋 未开始 | -    |
| REQ-049 | F3  | 项目领料 / 退料 / 报废与库存联动 | PRD | Phase 2 | 🔧 进行中 | -    |
| REQ-050 | F4  | 项目净耗用与成本台账 | PRD | Phase 2 | 📋 未开始 | -    |
| REQ-051 | F5  | customer 销售引用项目成品成本快照 | PRD | Phase 3 | 📋 未开始 | -    |
...
| REQ-056 | F5  | V1 预警视图、客户出库编号区间与共享查询合同 | PRD | Phase 3 | 🔧 进行中 | -                    |
