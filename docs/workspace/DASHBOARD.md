...
**空闲** 入库 Phase 2（FIFO + 来源成本）已交付，基础数据 Phase 1 已交付；`rd-project / sales-project / workshop-material / inventory-core / audit / ai-assistant` 领域需求文档已补全，待用户确认后冻结为正式基线。
...
| 优先级 | 事项 | 指向 |
|---|---|---|
| 1 | 确认并冻结新补全的 6 份领域需求文档 | `requirements/REQUIREMENT_CENTER.md` |
| 2 | 月度报表：F1-F5 待设计与实现 | `requirements/domain/monthly-reporting.md` |
