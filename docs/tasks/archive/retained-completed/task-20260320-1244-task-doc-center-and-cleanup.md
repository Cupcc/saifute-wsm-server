...
- [ ] Step 4: publish an evidence-based initial lifecycle classification for the current doc set inside `TASK_CENTER.md`.
  - `active`: `docs/tasks/task-20260317-1416-migration-outbound-base.md`, `docs/tasks/task-20260319-1035-migration-outbound-sales-return-formal-admission.md`, `docs/tasks/task-20260319-1045-migration-workshop-return-formal-admission.md`, `docs/tasks/archive/retained-completed/task-20260319-1100-migration-return-family-shared-post-admission.md`, `docs/tasks/task-20260319-1605-feishu-runtime-summary.md`, `docs/tasks/task-20260319-1715-feishu-subagent-runtime-duration.md`, and this new governance task while it remains open
