...
- Next action:
  - No further coder changes are required for this slice; downstream migration work can consume the current admitted sales-return baseline and proceed in `docs/tasks/archive/retained-completed/task-20260319-1100-migration-return-family-shared-post-admission.md`.
