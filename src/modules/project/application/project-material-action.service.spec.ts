...
import { ProjectMaterialActionService } from "./project-material-action.service";

describe("ProjectMaterialActionService", () => {
  let service: ProjectMaterialActionService;
  ...
  beforeEach(async () => {
    ...
    service = moduleRef.get(ProjectMaterialActionService);
    repository = moduleRef.get(ProjectRepository);
    inventoryService = moduleRef.get(InventoryService);
  });

  it("creates a pick action through inventory-core with project allocation target", async () => {
