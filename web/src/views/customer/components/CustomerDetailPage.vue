...
import { listDetail } from "@/api/customer/detail";
import { getOrder } from "@/api/customer/order";
import { listSalesReturnDetail } from "@/api/customer/salesReturnDetail";
import { getSalesReturnOrder } from "@/api/customer/salesReturnOrder";
