...
import { getOrder, listOrder, voidOrder } from "@/api/customer/order";
import {
  getSalesReturnOrder,
  listSalesReturnOrder,
  voidSalesReturnOrder,
} from "@/api/customer/salesReturnOrder";
import CustomerOrderDetailDialog from "./CustomerOrderDetailDialog.vue";
import CustomerOrderEditorDialog from "./CustomerOrderEditorDialog.vue";
...
const createPermission = computed(() =>
  isOrderMode.value ? "customer:order:create" : "customer:sales-return:create",
);
const updatePermission = computed(() => "customer:order:update");
const voidPermission = computed(() =>
  isOrderMode.value ? "customer:order:void" : "customer:sales-return:void",
);
