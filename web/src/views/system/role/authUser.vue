...
<template>
   <div class="app-container">
      ...
      <adaptive-table border stripe v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
...
function cancelAuthUser(row) {
  proxy.$modal
    ...
    .then(() =>
      authUserCancel({ userId: row.userId, roleId: queryParams.roleId }),
    )
    .then(() => {
      getList();
