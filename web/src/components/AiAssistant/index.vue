...
const contextMap = {
  ...
  "/out/outboundOrder": "出库管理 - 出库单",
  "/out/outboundDetail": "出库管理 - 出库明细",
  "/out/salesReturnOrder": "出库管理 - 退货单",
  "/out/salesReturnDetail": "出库管理 - 退货明细",
  "/stock/inventory": "库存管理 - 库存查询",
  "/stock/log": "库存管理 - 库存日志",
  "/stock/warning": "库存管理 - 库存预警",
  "/stock/interval": "库存管理 - 库存区间",
  "/stock/scrapOrder": "库存管理 - 报废单",
  "/stock/scrapDetail": "库存管理 - 报废明细",
  "/stock/used": "库存管理 - 已使用物料",
  "/take/pickOrder": "领料管理 - 领料单",
  "/take/pickDetail": "领料管理 - 领料明细",
  "/take/returnOrder": "领料管理 - 退料单",
  "/take/returnDetail": "领料管理 - 退料明细",
