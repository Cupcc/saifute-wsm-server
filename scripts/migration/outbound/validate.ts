      ...
      async (targetConnection) => {
        ...
        if (orderTargetRows < expectedMigratedOrders) {
          validationIssues.push({
            severity: "blocker",
            reason:
              "customer_stock_order row count is smaller than the migration plan.",
            expectedMigratedOrders,
          ...
          validationIssues.push({
            severity: "blocker",
            reason:
              "customer_stock_order contains more rows than this migration slice expects.",
            expectedMigratedOrders,
            actualOrderRows: orderTargetRows,
          });
        }
        ...
        if (lineTargetRows < expectedMigratedLines) {
          validationIssues.push({
            severity: "blocker",
            reason:
              "customer_stock_order_line row count is smaller than the migration plan.",
            expectedMigratedLines,
          ...
          validationIssues.push({
            severity: "blocker",
            reason:
              "customer_stock_order_line contains more rows than this migration slice expects.",
            expectedMigratedLines,
            actualLineRows: lineTargetRows,
          });
        }
