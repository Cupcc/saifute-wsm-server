export const FINALIZE_ORIGINATING_BATCH =
  "batch3c-outbound-sales-return-recoverable";
export const ALLOWED_FINALIZE_REASON = "no-upstream-line-candidate" as const;
export const FINALIZE_LEGACY_TABLE = "saifute_sales_return_order" as const;
