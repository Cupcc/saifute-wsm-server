...
export type SalesStockOrderTypeValue = "OUTBOUND";
...
export interface ArchivedFieldPayloadRecord {
  legacyTable: string;
  legacyId: number;
  targetTable: "sales_stock_order" | "sales_stock_order_line";
  targetCode: string;
...
export interface SalesStockOrderTargetInsert {
  documentNo: string;
  orderType: SalesStockOrderTypeValue;
  bizDate: string;
...
export interface SalesStockOrderLineTargetInsert {
  lineNo: number;
  materialId: number;
...
export interface OutboundLinePlanRecord {
  ...
  targetCode: string;
  target: SalesStockOrderLineTargetInsert;
...
export interface OutboundOrderPlanRecord {
  ...
  targetCode: string;
  target: SalesStockOrderTargetInsert;
