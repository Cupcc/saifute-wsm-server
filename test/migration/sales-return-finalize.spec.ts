import type { PendingRelationRecord } from "../../scripts/migration/sales-return/types";
import {
  buildFinalizationPlan,
  hasFinalizationBlockers,
} from "../../scripts/migration/sales-return-finalize/planner";
import type { PendingRelationDbRow } from "../../scripts/migration/sales-return-finalize/types";
import {
...
describe("sales-return-finalize plan builder", () => {
