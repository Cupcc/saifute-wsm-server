...
} from "../../scripts/migration/sales-return-finalize/execute-guard";
import type {
  ArchivedRelationDbRow,
  FinalizationArchiveCandidate,
  PendingRelationDbRow,
} from "../../scripts/migration/sales-return-finalize/types";
import { ALLOWED_FINALIZE_REASON } from "../../scripts/migration/sales-return-finalize/types";
...
describe("sales-return-finalize execute guard", () => {
