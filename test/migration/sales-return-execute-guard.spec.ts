...
} from "../../scripts/migration/sales-return/execute-guard";

describe("sales-return execute guard", () => {
  ...
  describe("buildDownstreamConsumerBlockers", () => {
    ...
    it("should block first execute when downstream consumers already reference SalesStockOrder rows", () => {
      expect(
        buildDownstreamConsumerBlockers({
          isRerun: false,
          consumerCounts: {
    ...
    it("should block rerun when downstream consumers already reference SalesStockOrder rows", () => {
      expect(
        buildDownstreamConsumerBlockers({
          isRerun: true,
          consumerCounts: {
